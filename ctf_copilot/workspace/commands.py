...
def register(sub):
    ...
    z=sp.add_parser('new',help='Create challenge workspace',description='Creates files/extracted/scripts/output/evidence folders plus notes.md.'); z.add_argument('name'); z.set_defaults(fn=lambda a: print(new(a.name)))
